  ...
  handler: async (ctx) => {
    ...
    for (const food of starterUsdaFoods) {
      ...
      const payload = {
        ...
        cholinePer100g: food.per100g.choline,
        copperPer100g: food.per100g.copper,
        ...
        manganesePer100g: food.per100g.manganese,
        name: food.name,
        niacinPer100g: food.per100g.niacin,
        omega3Per100g: food.per100g.omega3,
        ...
        seleniumPer100g: food.per100g.selenium,
